...
public class ERoadSign2 : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        {
            if (Jam1.JamOn1 && Jam3.JamOn3 && Jam4.JamOn4)
            {
                MessageText = "STOP";
                Situation = -2;
            }
            else if (Jam4.JamOn4 && Jam3.JamOn3)
            {
                MessageText = "GO LEFT";
                Situation = 0;
            }
            else if ( Jam1.JamOn1 && Jam4.JamOn4)
            {
                MessageText = "GO RIGHT";
                Situation = 1;
            }
            
            else if (Jam1.JamOn1 && Jam3.JamOn3)
            {
