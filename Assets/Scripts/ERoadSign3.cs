...
public class ERoadSign3 : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        {
            if (Jam1.JamOn1 && Jam2.JamOn2 && Jam4.JamOn4)
            {
                MessageText = "STOP";
                Situation = -2;
            }

            else if (Jam4.JamOn4 && Jam1.JamOn1)
            {
                MessageText = "GO LEFT";
                Situation = 0;
            }

            else if (Jam1.JamOn1 && Jam2.JamOn2)
            {
                MessageText = "GO RIGHT";
                Situation = 1;
            }

            else if (Jam2.JamOn2 && Jam4.JamOn4)
            {
