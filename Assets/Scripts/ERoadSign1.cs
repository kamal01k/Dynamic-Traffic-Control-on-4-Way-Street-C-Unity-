...
public class ERoadSign1 : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        {
            if (Jam2.JamOn2 && Jam3.JamOn3 && Jam4.JamOn4)
            {
                Situation = -2;
            }
            
            else if (Jam2.JamOn2 == true && Jam3.JamOn3 == true)
            {
                MessageText = "GO LEFT";
                Situation = 0;
            }
            else if (Jam3.JamOn3 == true && Jam4.JamOn4 == true)
            {
                MessageText = "GO RIGHT";
                Situation = 1;
            }
            else if (Jam4.JamOn4 && Jam2.JamOn2 == true)
            {
                MessageText = "GO FORWARD";
                Situation = 2;
            }
            else if (Jam3.JamOn3 == true)
            {
                MessageText = "LEFT   RIGHT";
                Situation = 3;
            }
            else if (Jam4.JamOn4 == true)
            {
                MessageText = "FORWARD  RIGHT";
                Situation = 4;
            }
            else if (Jam2.JamOn2 == true)
            {
                MessageText = "FORWARD  LEFT";
                Situation = 5;
            }
            else
                MessageText = "FORWARD   LEFT   RIGHT";
        }
        else
        {
            MessageText = "STOP";
