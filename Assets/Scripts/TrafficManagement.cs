...
public class TrafficManagement : MonoBehaviour {
    ...
    private void Manage()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            if (Times[i] == TT1 && TT1 != 0.0f && ERoadSign1.Situation != -2)
            {
    ...
    IEnumerator Greening(int x)
    {
        ...
        if (x == 1 && entered1 == false)
        {
            ...
            NCars = GameObject.FindGameObjectsWithTag("Lane1").Length;
        ...
        {
            NCars = GameObject.FindGameObjectsWithTag("Lane2").Length;
            if (NCars < 4)
                NCars = 1;
        ...
        {
            NCars = GameObject.FindGameObjectsWithTag("Lane3").Length;
            if (NCars < 4)
                NCars = 1;
            GT = (NCars) * 1.21f + 1;
        ...
        else if (x == 4 && entered1 == false)
        {
            ...
            NCars = GameObject.FindGameObjectsWithTag("Lane4").Length;
            if (NCars < 4)
                NCars = 1;
            GT = (NCars) * 1.21f + 1;
